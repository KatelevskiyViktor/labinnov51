...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" target="_blank" class="brand-link">
            <img src="{{ asset('storage/images/admin_logo.png') }}" alt="Логотип админки" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ asset('storage/images/non_ava.png') }}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="#" class="d-block">{{Auth::user()->name}}</a>
                    <a href="{{ route('logout') }}" class="d-block text-danger">Выйти из админки</a>
                </div>
            </div>
...
<script src="{{ asset('bigbro/ckeditor5/build/ckeditor.js') }}"></script>
<script src="{{ asset('bigbro/ckfinder/ckfinder.js') }}"></script>
<script>
    ClassicEditor
        .create( document.querySelector( '#content, #open' ), {
            ckfinder: {
